...
"""
Django settings for oyt_python project.
...
SECRET_KEY = '-n1qbvh=ra-tps&ti&iu5o(2_#=vv$t^zg=ovu27^e7)e#dm+n'
...
WSGI_APPLICATION = 'oyt_python.wsgi.application'
